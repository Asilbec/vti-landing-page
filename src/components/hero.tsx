                    ...
                    <div className="inline-block">
                        ...
                        <ul className="flex flex-wrap justify-center -m-8">
                            <li className="w-auto p-8">
                                <a className="text-sm text-black-400 hover:text-indigo-700 font-semibold uppercase tracking-px" href="#">Real-time Visualization</a>
                            </li>
                            <li className="w-auto p-8">
                                <a className="text-sm text-black hover:text-indigo-700 font-semibold uppercase tracking-px" href="#">Easy to Use</a>
                            </li>
                            <li className="w-auto p-8">
                                <a className="text-sm text-black-400 hover:text-indigo-700 font-semibold uppercase tracking-px" href="#">Clear Documentation</a>
                            </li>
                            <li className="w-auto p-8">
