        ...
        <section className="py-32 bg-white overflow-hidden">
          <div className="container px-4 mx-auto">
            <div className="flex flex-wrap lg:items-center -m-8">
              <div className="w-full md:w-1/2 p-8">
                <img className="mx-auto transform hover:-translate-y-4 transition ease-in-out duration-1000" src="flaro-assets/images/how-it-works/iphone.png" alt="" />
              </div>
              <div className="w-full md:w-1/2 p-8">
                      ...
                      <div className="flex-1 p-6">
                        <div className="md:max-w-xs">
                          ...
                          <p className="text-gray-700 font-medium leading-relaxed">
                            Lorem ipsum dolor sit amet, to the consectetur adipiscing
                            elit. Volutpat tempor condimentum.
                          </p>
                        </div>
                      </div>
                    </div>
